...
<title>BuscaF ... Detalle de SubCarpeta</title>
<!-- InstanceEndEditable --> 
					...
					<!-- InstanceBeginEditable name="contenido" --> 
							<table width="710"border="0" cellpadding="0" cellspacing="0">
								<tr>
									...
									/*if(isset($HTTP_POST_VARS['id_catalogo']) && isset($HTTP_POST_VARS['id_ruta']))
										$_pagi_sql="select count(*) from archivo where id_catalogo='".$HTTP_POST_VARS['id_catalogo']."' and ruta='".$HTTP_POST_VARS['id_ruta']."' ";				
									else*/
									
									$_pagi_sql="select count(*) from archivo where id_catalogo='".$_GET['id_catalogo']."' and ruta='".$_GET['id_ruta']."' ";				
									...
									include 'paginator.inc.php';
										...
										/*$busca = "SELECT id_catalogo,nombre_archivo, tamanho, ruta, extension
												  ...
												  "and  ruta='".$_GET['id_ruta']."' order by nombre_archivo ";*/
										...
										/* $busca = "SELECT a.id_archivo, a.id_catalogo,a.nombre_archivo, a.tamanho, a.ruta, a.extension,b.ubicacion 
												...
												where a.id_catalogo='".$_GET['id_catalogo']."'".
												"and a.ruta='".$_GET['id_ruta']."'".
												"and a.id_catalogo=b.id_catalogo order by a.nombre_archivo"; */
												
										$busca = "SELECT a.id_archivo, a.id_catalogo,a.nombre_archivo, a.tamanho, a.ruta, a.extension,b.ubicacion 
												from archivo a INNER JOIN catalogo b ON
												a.id_catalogo='".$_GET['id_catalogo']."'".
												"and a.ruta='".$_GET['id_ruta']."'".
												"and a.id_catalogo=b.id_catalogo order by a.nombre_archivo";
